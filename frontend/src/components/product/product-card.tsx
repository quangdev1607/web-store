 ...
 * Displays a single product in a card format with image, details, and add-to-cart action
 */
...
export function ProductCard({ product }: ProductCardProps) {
  ...
  const handleAddToCart = (e: React.MouseEvent) => {
    ...
    addItem({ ...product, id: productId } as Product, 1);
    setIsAdded(true);
...
/**
 * ProductCard skeleton for loading state
 */
export function ProductCardSkeleton() {
  return (
    <Card className="h-full cursor-pointer flex flex-col overflow-hidden">
      <CardHeader className="p-0">
